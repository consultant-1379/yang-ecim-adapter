...
public class Lock extends Rpc {
    ...
    @Override
    public Lock processTag(final String tag, final Attributes attributes, final int level) {
	...
	commandListener.lock(messageId, "0", datastore, out);
	return new Nop();
    }
}
