...
public class Validate extends Rpc {
    ...
    protected Validate(final Rpc rpc) {
	super(rpc);
	this.isTarget = false;
    ...
    @Override
    public Validate processTag(final String tag, final Attributes attributes, final int level) {
	...
	commandListener.validate(messageId, datastore, out);
	return new Nop();
    }
