...
public class NodeSupportDefaultFilterProcessorConfigData implements FilterProcessor {

    @Override
    public String getFilterStringApplicableToNode() {
        return DefaultFilterProvider.getInstance().getDefaultFilterConfigDataOnly(NODE_SUPPORT);
    }
